...
#define MIN_ROT_LIMIT_DEG_S      10.0f    // Floor rotation during deccel
...
#define STABILIZATION_GAIN       3.5f     // Corrective OMEGA per degree of error
...
#define CONTROL_LOOP_INTERVAL_MS 5        // main loop target period
